...
import com.CollegeCircle.clg.Adapter.CommentAdapter
import com.CollegeCircle.clg.Models.Comment
...
import com.CollegeCircle.clg.databinding.ActivityCommentBinding
...
class CommentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database.child("Profile").child(friendUid).get().addOnSuccessListener {
            var profile=it.getValue(ProfileMain::class.java)
            if (profile != null) {
                binding.uploaderNameComment.setText(profile.name)
