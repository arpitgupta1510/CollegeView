...
import com.CollegeCircle.clg.Models.*
import com.CollegeCircle.clg.Services.FirebaseServices
import com.CollegeCircle.clg.databinding.ActivityFriendsChatBinding
import com.CollegeCircle.clg.Services.RetrofitInstance
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val messageSwipeController = MessageSwipeController(this, object : SwipeControllerActions {
            override fun showReplyUI(position: Int) {
                ...
                txtQuotedMsg.text = messages[position].msg.toString()
...
//                }
        ...
        binding.friendChatMsgSentBtn.setOnClickListener {
            ...
            if (newMsg == "") {
                ...
                message = Message(null,newMsg, usersUid ,repliedTo,  System.currentTimeMillis().toString(), false, rand)
                hideReplyLayout()
                messages.add(message)
                msgAdapter.notifyDataSetChanged()
                binding.friendChatView.smoothScrollToPosition(messages.size - 1)
    ...
    private fun search(text: String?) {
        ...
        text?.let {
            messages.forEach { message ->
                if (message.msg.toString()?.contains(text, true) == true) {
