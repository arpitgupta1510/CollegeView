...
import com.CollegeCircle.clg.databinding.ActivityImageSelectBinding
...
class ImageSelect : AppCompatActivity() {
    ...
    private lateinit var galleryType:String
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        galleryType=intent.getStringExtra("GalleryType").toString()
        if(galleryType=="0")
            launchCamera()
