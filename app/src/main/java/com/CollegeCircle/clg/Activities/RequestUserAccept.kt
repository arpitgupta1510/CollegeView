...
import com.CollegeCircle.clg.Adapter.RequestAcceptAdapter
import com.CollegeCircle.clg.Models.ProfileMain
import com.CollegeCircle.clg.databinding.ActivityRequestUserAcceptBinding
...
class RequestUserAccept : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database.child("Colleges").child(clgUid.toString()).child("Users").addValueEventListener(object :
            ValueEventListener {
        ...
        binding.userView.adapter = userAdapter
