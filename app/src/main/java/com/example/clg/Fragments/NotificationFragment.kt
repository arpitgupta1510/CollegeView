...
import com.example.clg.Adapter.NotificationAdapter
import com.example.clg.Models.Notification
import com.example.clg.R
import com.example.clg.databinding.FragmentNotificationBinding
...
class NotificationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        database.child("Colleges").child(clgUid).child("Users")
            .child(usersUid).child("Notifications").limitToLast(20).addValueEventListener(object :
                ValueEventListener {
